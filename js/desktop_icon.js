	...
	function add_desktop_shortcut(shortcut_name,img_src){
		...
		tmp_element.droppable()
					...
					.dblclick(function(){create_window( shortcut_name );})
	...
	$.getJSON("setting/desktop_icons.json",function(tmp_json){
//		console.log(tmp_json.shortcut[0]);
		$.each(tmp_json.shortcut,function(){
